...
bam_filepath=c(
  system.file(package='RiboseQC',"ext_data","simp_arab_root.bam"),
  system.file(package='RiboseQC',"ext_data","simp_arab_shoot.bam"))

RiboseQC_analysis(
  annotation_file=annotation,bam_files = bam_filepath,
  fast_mode = TRUE,
...
```{r report_3,warning=FALSE, results='asis', fig.width=12, fig.height=10, dpi=120}

readRDS(file.path(tmp_dir,"simp_arab_root_shoots.html_plots/rds/sample1_nucl_4_profiles_P_sites_metagene_subcodon_all"))[[1]]
...
as_ggplot(readRDS(file.path(tmp_dir,"test_root_shoots.html_plots/rds/shoot_nucl_4_profiles_fivepr_metagene_subcodon_log2"))[[1]])
```
