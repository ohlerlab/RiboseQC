...
Let's now download annotation for *Homo sapiens*, a subset of the GENCODE 25 annotation (https://www.gencodegenes.org/human/release_25.html) and corresponding genome sequences.
...
Moreover, such function reads a genome file in *.2bit* to forge a *BSgenome* package for fast and efficient query of genomic sequences.
...
```{r arab_4, warning=FALSE, results='asis', fig.width=12, fig.height=8, dpi=150}
