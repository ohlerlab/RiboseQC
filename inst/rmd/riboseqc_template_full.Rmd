...
author: "Generated with RiboseQC"
...
Read lengths, as well as their individual offsets, are selected according to the parameters specified in the RiboseQC run.

**Note**: Not all samples and originating organelles might be displayed here. Please check the parameters used in the RiboseQC run.
...
Based on the parameters indicated in the RiboseQC run, the following read lengths (with their offsets) were selected to infer P-sites positions.
